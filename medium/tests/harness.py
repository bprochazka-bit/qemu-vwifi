...
Usage:
    make userspace
    python3 medium/tests/harness.py
    # or
    make test
...
# tests/ -> medium/ -> repo root
REPO_ROOT = Path(__file__).resolve().parents[2]

# The top-level Makefile builds into build/. Overridable so the harness can
# be pointed at an installed or otherwise-located hub.
MEDIUM_BIN = Path(os.environ.get('VWIFI_MEDIUM', REPO_ROOT / 'build' / 'vwifi-medium'))
